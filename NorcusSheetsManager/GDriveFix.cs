...
namespace NorcusSheetsManager
{
    public static class GDriveFix
    {
        ...
        public static string FixFile(string fullFileName, bool allowMultipleVersions)
        {
            ...
            GDriveFile file = new GDriveFile(fullFileName);
            ...
            List<string> allVersions = Directory.GetFiles(file.Directory, $"{file.FileNameNoVerNoExt}*{file.Extension}")
        ...
        public class GDriveFile
        {
            ...
            private void _SetProperties()
            {
                ...
                Version = Int32.Parse(Regex.Match(basicMatch.Value, "\\d+").Value);
